...
-- Получить нормаль относительно точки
--- Пример: UtilsBasePart.GetNormalRelativeToPosition(Parent.CFrame, Parent.Size, Player.Character.HumanoidRootPart.Position)
